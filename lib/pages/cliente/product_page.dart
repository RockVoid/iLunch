...
import 'package:ilunch/pages/cliente/confirmation_pedido_page.dart';
                  ...
                  Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(widget.product.linkImage),
                        fit: BoxFit.fill,
                      ),
                      boxShadow: [
                        BoxShadow(
                  ...
                  children: [
                    ListTile(
                      ...
                      subtitle: Text.rich(
                        TextSpan(
                          text:
                              'Serve até ${widget.product.servePeople} pessoa(s)\n',
                          style: GoogleFonts.poppins(
                            fontSize: 13,
                            fontWeight: FontWeight.w500,
                            color: Colors.black,
                            ...
                            children: [
                                ...
                                child: Text.rich(
                                  TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text: widget.product.vendedor.username,
                                        style: GoogleFonts.poppins(
                                          fontSize: 14,
                              ...
                              Text.rich(
                                TextSpan(
                                  children: [
                                    TextSpan(
                                      text: widget.product.vendedor.stars,
                                      style: GoogleFonts.poppins(
                                        fontSize: 14,
                                        fontWeight: FontWeight.w600,
                                      ),
                        ...
                        ElevatedButton(
                          onPressed: () {
                            Navigator.of(context).push(
                              PageTransition(
                                child: ConfirmationPedidoPage(product: widget.product,),
